            ...
            <div class="grid grid-cols-12 2xl:grid-cols-12 gap-x-5">
                ...
                <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                    <div class="text-center card-body">
                        ...
                        <h5 class="mt-4 mb-2"><span class="counter-value" data-target="{{ $CorporateOrders }}">0</span></h5>
                        <a href="">
                            <p class="text-slate-500 dark:text-zink-200">Order</p>
                        </a>
                    </div>
                </div><!--end col-->
                ...
                <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                    <div class="text-center card-body">
                        ...
                        <h5 class="mt-4 mb-2"><span class="counter-value" data-target="{{ $member }}">0</span></h5>
                        <a href="{{ route('Memberlist') }}">
                            <p class="text-slate-500 dark:text-zink-200">User</p>
                        </a>
                    </div>
                </div><!--end col-->
            </div><!--end grid-->
