                ...
                <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                    ...
                    <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
                        <li
                            ...
                            <a href="{{ route('B2BUserHome') }}" class="text-slate-400 dark:text-zink-200">Home</a>
                        </li>
                    ...
                    <div class="xl:col-span-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('B2BUserChange_password') }}" method="post">
                                    @csrf
                                    <input type="hidden" name="id"
                                        value="{{ $sessionUsers_id = session('Users_id') }}">
