                                    ...
                                    <div class="bg-white shadow rounded-md dark:bg-zink-600">
                                        ...
                                        <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                                            <form onsubmit="return validateFile()" class="tablelist-form"
                                                ...
                                                action="{{ route('blog.update', $data->blogId) }}" method="POST">
                                                @csrf
                                                ...
                                                <div class="grid grid-cols-3 gap-4">
                                                    ...
                                                    <div class="mb-3 ">
                                                        ...
                                                        <input type="file" id="edit_img" name="edit_img"
                                                            ...
                                                            autocomplete="off">
                                                        <div id="viewimg">
                                                            <img src="{{ asset('upload/Blog/') . '/' . $data->strPhoto }}"
                                                                height="70" width="70" alt="">

                                                        </div>
                                                    </div>
                                                    <input type="hidden" name="hiddenPhoto" class="form-control"
                                                        value="{{ old('edit_img') ? old('edit_img') : $data->strPhoto }}"
                                                        id="hiddenPhoto">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea id="metaTitle" name="metaTitle" rows="4"
                                                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                            placeholder="Meta Title" autocomplete="off" autofocus="">{{ $data->metaTitle }}</textarea>
                                                        @error('metaTitle')
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea id="metaKeyword" name="metaKeyword" rows="4"
                                                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                            placeholder="Meta Keyword" autocomplete="off" autofocus="">{{ $data->metaKeyword }}</textarea>
                                                        @error('metaKeyword')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea id="metaDescription" name="metaDescription" rows="4"
                                                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                            placeholder="Meta Description" autocomplete="off" autofocus="">{{ $data->metaDescription }}</textarea>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea id="head" name="head" rows="4"
                                                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                            placeholder="Meta Head" autocomplete="off" autofocus="">{{ $data->head }}</textarea>
                                                        @error('head')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea id="body" name="body" rows="4"
                                                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                            placeholder="Meta body" autocomplete="off" autofocus="">{{ $data->body }}</textarea>
                                                        @error('body')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea id="strDescription" name="strDescription" class="ckeditor-classic text-slate-800"
                                                        style="height: 300px !important;">{{ $data->strDescription }}</textarea>
                                                </div>
