                                ...
                                <form onsubmit="return validateFile()" class="tablelist-form"
                                    ...
                                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
                                        ...
                                        <div class="">
                                            ...
                                            <select name="serviceid" id="serviceid" onchange="getsearchsubservice();"
                                                class="form-select border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                                <option selected="" value="">Select Service</option>
                                                @foreach ($Services as $Service)
                                                    <option value="{{ $Service->id }}"
                                                        @if (isset($serviceid) && $serviceid == $Service->id) {{ 'selected' }} @endif>
                                                        {{ $Service->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="">
                                            <span style="color:red;"></span>Sub Service
                                            <select name="subservice_id" id="subservice_id"
                                                class="form-select border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                                <option selected="" value="">Select Service</option>
                                                @foreach ($SubService as $SubServi)
                                                    <option value="{{ $SubServi->sub_service_id }}"
                                                        @if (isset($subservice_id) && $subservice_id == $SubServi->sub_service_id) {{ 'selected' }} @endif>
                                                        {{ $SubServi->subservice_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <table class="w-full whitespace-nowrap" id="customerTable">
                                            <thead class="bg-slate-100 dark:bg-zink-600">
                                                <tr>
                                                    ...
                                                    <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                                        data-sort="are_name">Sub Service Name</th>
