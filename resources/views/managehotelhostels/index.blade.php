...
@section('title', 'Manage Hotel/Hostels List')
@section('content')
    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Manage Hotel/Hostels List</h5>
                </div>
                        ...
                        <div class="card-body">
                            <div class="grid grid-cols-1 gap-5 mb-5 xl:grid-cols-0">
                                ...
                                <div class="rtl:md:text-start">
                                    @if (!$managehotelhostal->isEmpty())
                                        <button type="button" onclick="confirmBulkDelete()"
                                            class="text-white transition-all duration-200 ease-linear btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">
                                            Delete Selected
                                        </button>
                                    @endif
                                    <a class="mx-1 ltr:md:text-end" title="Add Hotel/Hostels"
                                        href="{{ route('manage_hotel_hostels.add') }}" style="float: inline-end;">
                                        <button type="submit"
                                            class="text-white transition-all duration-200 ease-linear btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">
                                            <i class="ri-add-box-fill"></i> Add Hostel/Hotels
                                        </button>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="overflow-x-auto">
                                @if (!$managehotelhostal->isEmpty())
                                    <form id="bulkDeleteForm" method="POST"
                                        action="{{ route('manage_hotel_hostels.deleteselected') }}">
                                        @csrf
                                        @method('DELETE')
                                        ...
                                        <table class="w-full whitespace-nowrap" id="customerTable">
                                            <thead class="bg-slate-100 dark:bg-zink-600">
                                                <tr>
                                                    ...
                                                    <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                                        data-sort="are_name">Contact Name</th>
                                                    ...
                                                    <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                                        data-sort="state_name">Company Name</th>

                                                    <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                                        data-sort="state_name">GST No</th>

                                                    <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                                        data-sort="state_name">Hotel/Hostel</th>
                                            ...
                                            <tbody class="list form-check-all">
                                                <?php $i = 1; ?>
                                                @foreach ($managehotelhostal as $managehothos)
                                                    <tr>
                                                        <th class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500"
                                                            ...
                                                            <input
                                                                ...
                                                                value="{{ $managehothos->Customer_id }}">
                                                        </th>

                                                        <td
                                                            class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 id">
                                                            {{ $i + $managehotelhostal->perPage() * ($managehotelhostal->currentPage() - 1) }}
                                                        </td>
                                                        ...
                                                        <td
                                                            ...
                                                            {{ $managehothos->Customer_name }}</td>

                                                        <td
                                                            class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 customer_name">
                                                            {{ $managehothos->Customer_phone }}</td>

                                                        <td
                                                            class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 customer_name">
                                                            {{ $managehothos->email }}</td>

                                                        <td
                                                            class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 customer_name">
                                                            {{ $managehothos->company_name }}</td>

                                                        <td
                                                            class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 customer_name">
                                                            {{ $managehothos->Gst_no }}</td>

                                                        <td
                                                            class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 customer_name">
                                                            @if ($managehothos->hotelhostel_name == 1)
                                                                Hotel
                                                            @elseif ($managehothos->hotelhostel_name == 2)
                                                                Hostel
                                                            @else
                                                                -
                                                            @endif
                                                        ...
                                                        <td
                                                            class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 customer_name">
                                                            @if ($managehothos->role == 1)
                                                                Customer
                                                            @elseif ($managehothos->role == 2)
                                                                Contract
                                                            @else
                                                                -
                                                            @endif
                                                        ...
                                                        <td
                                                            ...
                                                            <div class="items-center">
                                                                <div
                                                                    ...
                                                                    @if ($managehothos->iStatus == 1)
                                                                        <input type="checkbox" name="greenIconSwitch"
                                                                            id="greenIconSwitch{{ $managehothos->id }}"
                                                                            ...
                                                                            onchange="updateStatus(<?= $managehothos->iStatus ?>,<?= $managehothos->Customer_id ?>);"
                                                                            checked="">
                                                                    @else
                                                                        <input type="checkbox" name="greenIconSwitch"
                                                                            id="greenIconSwitch{{ $managehothos->id }}"
                                                                            ...
                                                                            onchange="updateStatus(<?= $managehothos->iStatus ?>,<?= $managehothos->Customer_id ?>);">
                                                                    @endif
                                                                    <label for="greenIconSwitch{{ $managehothos->id }}"
                                                            ...
                                                            <div class="flex gap-2">
                                                                <div class="edit">
                                                                    <a class="mx-1" title="Edit"
                                                                        href="{{ route('manage_hotel_hostels.edit', $managehothos->Customer_id) }}">
                                                                        <i class="ri-edit-2-fill"></i>
                                                                    </a>

                                                                    <a class="mx-1" title="Delete" href="#"
                                                                        onclick="confirmSingleDelete({{ $managehothos->Customer_id }})">
                                                                        <i class="ri-delete-bin-5-fill"></i>
                                                                    </a>
                                                                    <a class="mx-1" title="Mail Send"
                                                                        href="{{ route('manage_hotel_hostels.Technicialmailsend', $managehothos->Customer_id) }}">
                                    ...
                                    <div class="flex items-center justify-between mt-5">
                                        {{ $managehotelhostal->appends(request()->except('page'))->links() }}
                                    </div>
                                @else
                                    <div class="noresult">
    ...
    <script>
        function updateStatus(status, managehothosId) {
            //$("p").toggle();
            $('#loading').css("display", "block");
            $.ajax({
                type: 'POST',
                url: "{{ route('manage_hotel_hostels.updateStatus') }}",
                data: {
                    status: status,
                    managehothosId: managehothosId
                },
                headers: {
    ...
    <script>
        ...
        function confirmSingleDelete(id) {
            Swal.fire({
                ...
                if (result.value) {
                    fetch('{{ route('manage_hotel_hostels.delete', ['id' => '__id__']) }}'.replace('__id__', id), {
                            method: 'DELETE',
                            headers: {
