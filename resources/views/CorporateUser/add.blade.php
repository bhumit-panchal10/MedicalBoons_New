...
@section('title', 'Add Corporate User')
@section('content')
    {!! Toastr::message() !!}
                                ...
                                <div class="rtl:md:text-start">
                                    <div class="bg-white shadow rounded-md dark:bg-zink-600">
                                        <div
                                            ...
                                            <h5 class="text-16" id="exampleModalLabel">Add Corporate User</h5>
                                        ...
                                        <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                                            <form onsubmit="return validateFile()" class="tablelist-form"
                                                action="{{ route('Corporate_User.store') }}" method="POST"
                                                ...
                                                <div class="grid grid-cols-3 gap-4">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" id="email-field" name="company_name"
                                                            maxlength="20"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" id="email-field" name="contact_person"
                                                            ...
                                                            autofocus value="{{ old('contact_person') }}">
                                                    </div>

                                                    <div class="mb-3">
                                                        <label for="email-field" class="">Mobile<span
                                                                class="text-red-500">*</span></label>
                                                        <input type="text" id="email-field" name="mobile" maxlength="10"
                                                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="email-field" class="">Email<span
                                                                class="text-red-500">*</span></label>
                                                        <input type="email" id="email-field" name="email" maxlength="50"
                                                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="email-field" class="">Password<span
                                                                class="text-red-500">*</span></label>
                                                        <input type="password" id="email-field" name="password"
                                                            maxlength="20"
                                                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
