    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Order List</h5>
                </div>
                                            ...
                                            <tbody class="list form-check-all">
                                                ...
                                                @foreach ($CorporateOrders as $CorporateOrder)
                                                    <tr>
                                                        ...
                                                        <td
                                                            class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 customer_name">
                                                            {{ date('d-m-Y', strtotime($CorporateOrder->start_date)) }}
                                                        </td>
                                                        <td
                                                            class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 customer_name">
                                                            {{ date('d-m-Y', strtotime($CorporateOrder->end_date)) }}</td>

                                                        <td
                                                            class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">
                                                            @if ($CorporateOrder->is_corporate == 1)
                                                                <div class="flex gap-2">
                                                                    <div class="edit">
                                                                        <a class="mx-1" title="Display Member"
                                                                            href="{{ route('Memberlist', $CorporateOrder->Corporate_Order_id) }}">
