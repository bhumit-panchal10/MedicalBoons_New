...
@section('title', 'Edit Plan Detail')
@section('content')
    {!! Toastr::message() !!}
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                ...
                <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
                    ...
                    <li
                        class="relative before:content-['\ea54'] before:font-remix ltr:before:-right-1 rtl:before:-left-1  before:absolute before:text-[18px] before:-top-[3px] ltr:pr-4 rtl:pl-4 before:text-slate-400 dark:text-zink-200">
                        <a href="{{ route('plan_detail.index', $plandetail->plan_id) }}"
                            class="text-slate-400 dark:text-zink-200">Plan
                            Detail
                            List</a>
                    </li>
                                ...
                                <div class="rtl:md:text-start">
                                    <div class="bg-white shadow rounded-md dark:bg-zink-600">
                                        <div
                                            ...
                                            <h5 class="text-16" id="exampleModalLabel">Edit Plan Detail</h5>
                                            <a href="{{ route('plan_detail.index', $plandetail->plan_id) }}">
                                                <button type="button"
                                        ...
                                        <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                                            <form onsubmit="return validateFile()" class="tablelist-form"
                                                action="{{ route('plan_detail.update') }}" method="POST">
                                                @csrf

                                                <div class="grid grid-cols-3 gap-4">
                                                    <input type="hidden" name="plan_detail_id"
                                                        value="{{ $plandetail->id }}">
                                                    <input type="hidden" name="plan_id" value="{{ $plandetail->plan_id }}">
                                                    <div class=" mb-3">
                                                        <label for="email-field" class="">Service<span
                                                                class="text-red-500">*</span></label>
                                                        <select name="editserviceid" id="editserviceid"
                                                            onchange="getsubservice();" required
                                                            class="form-select border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                                            <option selected="" value="">Select Service</option>
                                                            @foreach ($Services as $Service)
                                                                <option value="{{ $Service->id }}"
                                                                    {{ $plandetail->service_id == $Service->id ? 'selected' : '' }}>
                                                                    {{ $Service->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                        ...
                                                        <select name="editsubserviceid" id="editsubserviceid" required
                                                            ...
                                                            @foreach ($SubServices as $SubService)
                                                                <option value="{{ $SubService->sub_service_id }}"
                                                                    {{ $plandetail->sub_service_id == $SubService->sub_service_id ? 'selected' : '' }}>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" name="valuation"
                                                            ...
                                                            placeholder="Enter Valuation" autocomplete="off"
                                                            value="{{ $plandetail->valuation }}" autofocus>
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" name="amount"
                                                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                            placeholder="Enter Valuation" autocomplete="off"
                                                            value="{{ $plandetail->amount }}" autofocus>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="email-field" class="">Discount</label>
                                                        <input type="text" name="editdiscount" maxlength="3"
                                                            oninput="this.value = this.value.replace(/[^0-9]/g, '');"
                                                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                            placeholder="Enter Discount" autocomplete="off"
                                                            value="{{ $plandetail->discount }}" autofocus>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" name="extra_amount"
                                                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                            placeholder="Enter Extra Amount" autocomplete="off"
                                                            value="{{ $plandetail->extra_amount }}" autofocus>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" name="session_count"
                                                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                            placeholder="Enter Session"autocomplete="off"
                                                            value="{{ $plandetail->session_count }}" autofocus>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" name="opd_support"
                                                            ...
                                                            value="{{ $plandetail->opd_support }}" autofocus>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" name="wellness_support"
                                                            ...
                                                            autocomplete="off"
                                                            value="{{ $plandetail->wellness_support }}" autofocus>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" name="lab_support"
                                                            ...
                                                            autocomplete="off" value="{{ $plandetail->lab_support }}"
                                                            autofocus>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" name="health_insurance_guidance"
                                                            ...
                                                            autocomplete="off"
                                                            value="{{ $plandetail->health_insurance_guidance }}"
                                                            autofocus>
                                                ...
                                                <div class="mb-3">
                                                    <label for="email-field" class="">Service Description<span
                                                            class="text-red-500">*</span></label>
                                                    <textarea name="service_description" class="ckeditor-classic text-slate-800" placeholder="Enter Description"
                                                        autocomplete="off" autofocus>{{ $plandetail->service_description }}</textarea>
                                                </div>
        ...
        function getsubservice() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $("#editsubserviceid").html('');
                    $("#editsubserviceid").append(data);
                }
            });
        }
    </script>
