...
@section('content')
    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Banner List</h5>
                </div>
                                ...
                                <div class="rtl:md:text-start">
                                    <div class="bg-white shadow rounded-md dark:bg-zink-600">
                                        <div
                                            ...
                                            <h5 class="text-16" id="exampleModalLabel">Add Banner</h5>
                                        </div>
                                        <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                                            <form onsubmit="return validateFile()" class="tablelist-form"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="email-field" name="Title" maxlength="150"
                                                ...
                                                <div class="mb-3">
                                                    <label for="email-field" class="">Image <span
                    ...
                    <div class="card" id="customerList">
                        <div class="card-body">
                            ...
                            <div class="overflow-x-auto">
                                @if (!$Banners->isEmpty())
                                    <form id="bulkDeleteForm" method="POST" action="{{ route('Banner.deleteselected') }}">
                                        @csrf
                                        @method('DELETE')
                                                ...
                                                @foreach ($Banners as $Banner)
                                                    <tr>
                                                        ...
                                                        <td
                                                            ...
                                                            @if ($Banner->image)
                                                                <img class="img-fluid"
                                                                    src="{{ asset('upload/Banner') . '/' . $Banner->image }}"
                                                            ...
                                                            <div class="flex gap-2">
                                                                <div class="edit">
                                                                    <a class="mx-1" title="Edit" href="#"
                                                                        ...
                                                                        onclick="getEditData(<?= $Banner->id ?>)">
                                                                        <i class="ri-edit-2-fill"></i>
                                                                    </a>

                                                                    <a class="mx-1" title="Delete" href="#"
                                                                        onclick="confirmSingleDelete({{ $Banner->id }})">
            ...
            <div id="EditModal" modal-center=""
                ...
                <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
                    <div class="flex items-center justify-between p-4 border-b border-slate-200 dark:border-zink-500">
                        <h5 class="text-16" id="exampleModalLabel">Edit Banner</h5>
                    ...
                    <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                        <form class="tablelist-form" onsubmit="return EditvalidateFile()"
                            action="{{ route('Banner.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" id="banner_id" name="banner_id" />

                            <div class="mb-3">
                                <label for="email-field" class="">Title<span class="text-red-500">*</span></label>
            ...
            if (id) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        console.log(obj);
                        var imageUrl = obj.image ? "{{ asset('upload/Banner') }}/" + obj
    ...
    <script>
        function checkAll(source) {
            checkboxes = document.querySelectorAll('input[name="Banner_ids[]"]');
            checkboxes.forEach(checkbox => checkbox.checked = source.checked);
        }

        function confirmBulkDelete() {
            const selected = document.querySelectorAll('input[name="Banner_ids[]"]:checked');
        ...
        function confirmSingleDelete(id) {
            Swal.fire({
                ...
                if (result.value) {
                    fetch('{{ route('Banner.delete', ['id' => '__id__']) }}'.replace('__id__', id), {
                            method: 'DELETE',
                            headers: {
