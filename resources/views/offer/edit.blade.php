                                ...
                                <div class="rtl:md:text-start">
                                    <div class="bg-white shadow rounded-md dark:bg-zink-600">
                                        <div
                                            ...
                                            <h5 class="text-16" id="exampleModalLabel">Edit Offer</h5>
                                        ...
                                        <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                                            <form onsubmit="return validateFile()" class="tablelist-form"
                                                action="{{ route('offer.update', $data->id) }}" method="POST"
                                                enctype="multipart/form-data">
                                                @csrf

                                                <div class="grid grid-cols-3 gap-4">
                                                    <input type="hidden" name="offerid" value="{{ $data->id }}">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" id="email-field" name="text"
                                                            ...
                                                            value="{{ $data->text }}" placeholder="Enter code" required
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select id="Categoryid" name="Categoryid[]" multiple required
                                                            ...
                                                            @foreach ($categories as $aty)
                                                                <?php
                                                                $data = [];
                                                                ?>
                                                                @foreach ($CategoryOffer as $act2)
                                                                    <?php
                                                                    $data[] = $act2->categoryId;
                                                                    ?>
                                                                @endforeach
                                                                <option value="{{ $aty->Categories_id }}"
                                                                    @if (in_array($aty->Categories_id, $data)) selected @endif>
                                                                    {{ $aty->Category_name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
