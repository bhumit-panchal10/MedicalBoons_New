...
@section('title', 'Edit Lab Test Inquiry')
@section('content')
    {!! Toastr::message() !!}
                                ...
                                <div class="rtl:md:text-start">
                                    <div class="bg-white shadow rounded-md dark:bg-zink-600">
                                        <div
                                            ...
                                            <h5 class="text-16" id="exampleModalLabel">Edit Lab Test Inquiry</h5>
                                        ...
                                        <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                                            <form onsubmit="return validateFile()" class="tablelist-form"
                                                action="{{ route('LabTestinquiryReport.update', $data->LabReport_Request_id) }}"
                                                method="POST">
                                                @csrf
                                                ...
                                                <div class="grid grid-cols-3 gap-4">
                                                    ...
                                                    <div class=" mb-3">
                                                        <label for="email-field" class="">Lab<span
                                                                class="text-red-500">*</span></label>
                                                        <select name="edit_labid" id="editlabid" required
                                                            ...
                                                            @foreach ($labs as $lab)
                                                                <option value="{{ $lab->Lab_Master_id }}"
                                                                    {{ $data->Lab_id == $lab->Lab_Master_id ? 'selected' : '' }}>
                                                                    {{ $lab->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="email-field" class="">Visit<span
                                                                class="text-red-500">*</span></label>
                                                        <select name="visit" id="editvisit" required
                                                            class="form-select border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                                            <option selected="" value="">Select Visit</option>
                                                            <option value="1"
                                                                @if ($data->visit == 1) selected @endif>Home Visit
                                                            </option>
                                                            <option value="2"
                                                                @if ($data->visit == 2) selected @endif>Center
                                                                Visit</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="email-field" class="">Date<span
                                                                class="text-red-500">*</span></label>
                                                        <input type="date" id="email-field" name="edit_date"
                                                            maxlength="150"
