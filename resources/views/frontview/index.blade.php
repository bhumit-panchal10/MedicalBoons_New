            ...
            <div class="services-grid-plain">
                ...
                @foreach ($Services as $service)
                    <div class="service-item-plain animate" data-delay="0">
                        <div class="service-icon-plain {{ !str_starts_with($service->color, '#') ? $service->color : '' }}"
                            @if (str_starts_with($service->color, '#')) style="background-color: {{ $service->color }}" @endif>
                            {!! $service->icon !!}
                        </div>
                ...
                <div class="col-lg-9">
                    <div class="plans-grid">
                        ...
                        @foreach ($plans as $plan)
                            ...
                            <div class="plan-card {{ $plan->name == 'Gold Plan' ? 'featured' : '' }} animate"
                                data-delay="100">
