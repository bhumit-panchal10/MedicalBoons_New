            ...
            <div class="grid">
                <div class="card">
                    ...
                    <div class="pair">
                        ...
                        <div class="v mono">{{ $CorporateOrder->invoice_no ?? 'RBH2324/13865' }}</div>
                    </div>
                    <div class="pair">
                        <div class="k">Invoice Date:</div>
                        <div class="v">
                            {{ date('d-m-y', strtotime($CorporateOrder->created_at)) ?? 'March 16, 2024, 5:25 p.m.' }}
                        </div>
                    </div>
                    {{-- <div class="pair">
                        <div class="k">Order No.:</div>
                        <div class="v mono">{{ $CorporateOrder->Corporate_Order_id ?? '141373' }}</div>
                    </div> --}}
                </div>
                <div class="card">
                    ...
                    <div class="pair">
                        ...
                        <div class="v">{{ $CorporateOrder->Name ?? 'Pritesh J Shah' }}</div>
                    </div>
                    <div class="pair">
