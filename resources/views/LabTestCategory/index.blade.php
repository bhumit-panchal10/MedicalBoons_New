...
@section('title', 'LabTestCategory List')
@section('content')
    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">LabTestCategory List</h5>
                </div>
                                ...
                                <div class="rtl:md:text-start">
                                    <div class="bg-white shadow rounded-md dark:bg-zink-600">
                                        <div
                                            ...
                                            <h5 class="text-16" id="exampleModalLabel">Add Lab Test Category</h5>
                                        </div>
                                        <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                                            <form method="POST" onsubmit="return validateFile()"
                                                action="{{ route('lab_test_cate.store') }}" id="registerForm"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="email-field" name="categoryame" maxlength="50"
                                                ...
                                                <div class="mb-3">
                                                    <label for="email-field"
                                                        class="inline-block mb-2 text-base font-medium">Display
                                                        Priority<span class="text-red-500"> *</span> </label>
                                                    <input type="number" id="email-field" name="display_priority"
                                                        maxlength="50"
                                                        class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                        placeholder="Enter Display Priority" required autocomplete="off"
                                                        autofocus>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea id="email-field" name="description"
                                                        class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                            ...
                            <div class="overflow-x-auto">
                                @if (!$LabTestCategory->isEmpty())
                                    <form id="bulkDeleteForm" method="POST"
                                        action="{{ route('lab_test_cate.deleteselected') }}">
                                        @csrf
                                        @method('DELETE')
                                        ...
                                        <table class="w-full whitespace-nowrap" id="customerTable">
                                            <thead class="bg-slate-100 dark:bg-zink-600">
                                                <tr>
                                                    ...
                                                    <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 "
                                                        data-sort="state_name">Display Priority</th>
                                            ...
                                            <tbody class="list form-check-all">
                                                <?php $i = 1; ?>
                                                @foreach ($LabTestCategory as $Labtestcat)
                                                    <tr class="text-center">
                                                        <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500"
                                                            scope="row">
                                                            <input
                                                                class="border rounded-sm appearance-none cursor-pointer size-4 bg-slate-100 border-slate-200 dark:bg-zink-600 dark:border-zink-500 checked:bg-custom-500 checked:border-custom-500 dark:checked:bg-custom-500 dark:checked:border-custom-500 checked:disabled:bg-custom-400 checked:disabled:border-custom-400"
                                                                type="checkbox" name="Lab_Test_Category_ids[]"
                                                                value="{{ $Labtestcat->Lab_Test_Category_id }}">
                                                        </td>

                                                        <td
                                                            class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 id">
                                                            {{ $i + $LabTestCategory->perPage() * ($LabTestCategory->currentPage() - 1) }}
                                                        </td>
                                                        ...
                                                        <td
                                                            ...
                                                            <div class="items-center">
                                                                <div
                                                                    ...
                                                                    @if ($Labtestcat->iStatus == 1)
                                                                        <input type="checkbox" name="greenIconSwitch"
                                                                            id="greenIconSwitch{{ $Labtestcat->Lab_Test_Category_id }}"
                                                                            ...
                                                                            onchange="updateStatus(<?= $Labtestcat->iStatus ?>,<?= $Labtestcat->Lab_Test_Category_id ?>);"
                                                                            checked="">
                                                                    @else
                                                                        <input type="checkbox" name="greenIconSwitch"
                                                                            id="greenIconSwitch{{ $Labtestcat->Lab_Test_Category_id }}"
                                                                    ...
                                                                    @endif
                                                                    <label
                                                                        for="greenIconSwitch{{ $Labtestcat->Lab_Test_Category_id }}"
                                                            ...
                                                            <div class="gap-2">
                                                                <div class="edit">
                                                                    <a class="mx-1" title="Edit" href="#"
                                                                        ...
                                                                        onclick="getEditData(<?= $Labtestcat->Lab_Test_Category_id ?>)">
                                                                        <i class="ri-edit-2-fill"></i>
                                                                    </a>

                                                                    <a class="mx-1" title="Delete" href="#"
                                                                        onclick="confirmSingleDelete({{ $Labtestcat->Lab_Test_Category_id }})">
                ...
                <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
                    ...
                    <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                        <form class="tablelist-form" onsubmit="return EditvalidateFile()"
                            action="{{ route('lab_test_cate.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" id="lab_testcat_id" name="lab_testcat_id" />
                            <div class="mb-3">
                                <label for="Countryname-field" class="inline-block mb-2 text-base font-medium">Service
                                    Name
                                    <span class="text-red-500"> *</span>
                                </label>
                                <input type="text" name="labtest_cat_name" id="Edit_labtest_cat_name" maxlength="50"
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                            ...
                            <div class="mb-3">
                                <label for="email-field" class="inline-block mb-2 text-base font-medium">Display
                                    Priority<span class="text-red-500"> *</span> </label>
                                <input type="number" id="Editdisplay_priority" name="Editdisplay_priority"
                                    maxlength="50"
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                    placeholder="Enter Display Priority" required autocomplete="off" autofocus>
                            </div>
                            ...
                            <div class="flex justify-end gap-2">
                                ...
                                <a href="{{ route('lab_test_cate.index') }}">
                                    <button type="button"
                                        class="text-white transition-all duration-200 ease-linear btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">
                                        Cancel
                                    </button>
    ...
    <script>
        function getEditData(id) {
            var url = "{{ route('lab_test_cate.edit', ':id') }}";
            ...
            if (id) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        console.log(obj);
                        $("#Edit_labtest_cat_name").val(obj.name);
                        $("#Editdisplay_priority").val(obj.display_priority);
                        $("#editdescription").val(obj.description);

                        $('#lab_testcat_id').val(obj.Lab_Test_Category_id);
                    },
                    error: function(xhr) {
    ...
    <script>
        function checkAll(source) {
            checkboxes = document.querySelectorAll('input[name="Lab_Test_Category_ids[]"]');
            checkboxes.forEach(checkbox => checkbox.checked = source.checked);
        }

        function confirmBulkDelete() {
            const selected = document.querySelectorAll('input[name="Lab_Test_Category_ids[]"]:checked');
        ...
        function confirmSingleDelete(id) {
            Swal.fire({
                ...
                if (result.value) {
                    fetch('{{ route('lab_test_cate.delete', ['id' => '__id__']) }}'.replace('__id__', id), {
                            method: 'DELETE',
                            headers: {
                        ...
                        .then(data => {
                            if (data.success) {
                                Swal.fire({
                                    ...
                                    window.location.href = '{{ route('lab_test_cate.index') }}';
                                });
                                // location.reload());
                            } else {
                                Swal.fire({
    ...
    <script>
        function updateStatus(status, labtestcatId) {
            //$("p").toggle();
            $('#loading').css("display", "block");
            $.ajax({
                type: 'POST',
                url: "{{ route('lab_test_cate.updateStatus') }}",
                data: {
                    status: status,
