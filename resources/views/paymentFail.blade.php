            ...
            <div class="row">
                <div class="card mx-auto d-block "
                    ...
                    <div class="col-md-12 d-block" style="text-align: center;">
                        <h1 style="border-bottom:1px solid #80563e;">Opps!</h1>
                    </div>
                    <div class="col-md-12 d-block text-center">
                        <p><br />
                            Payment failed. Please try again or contact support if the issue continues.
                        </p>
                        <a class="btn btn-danger" href="{{ route('Front.index') }}">Retry Payment</a>
                    </div>
